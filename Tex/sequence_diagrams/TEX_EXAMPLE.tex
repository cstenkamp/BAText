...
\begin{document}
	...
	\begin{figure}
		...
		\begin{sequencediagram}
			\newthread{ss}{:SimulationServer}{SimulationServer}
			\newinst{ctr}{:SimControlNode}{SimControlNode}
			\newinst{ps}{:PhysicsServer}{PhysicsServer}
			\newinst[1]{sense}{:SenseServer}{SenseServer}
	...
	\begin{sequencediagram}
		...
		\newinst{ps}{:PhysicsServer}{PhysicsServer}
		\newinst[1]{sense}{:SenseServer}{SenseServer}
		\newthread[red]{ctr}{:SimControlNode}{SimControlNode}
