...
This method simulates an environment that rewards the actions from the pretraining as demanded and provides a reward of zero for any other action. While this makes it possible to perform q-pretraining, the result cannot be perfect, as all actions are punished hard.

\colorbox{red}{dass getAcurracy das flag likeDDPG hat}
\colorbox{red}{dass beim DDPG ne bessere funktion mit gaussian distance überlegt ist aber nicht klappt}
\colorbox{red}{dass results davon, und wie gut das pretraining übernommen werden kann, später gezeigt wird}

\subsection{Exploration}

-der sv-agent hat natürlich keine exploration, die anderen schon
...
\subsubsection{dqn\_rl\_agent and dqn\_novision\_rl\_agent}

-dass das in abstractrlagent ist
...
-dass man ähnliche actions mit ner höheren wahrscheinlichkeit nehmen könnte, boltzmann, oder einfach eine normale dediscretisieren und noise drauf packen könnte

\subsubsection{ddpg\_rl\_agent and ddpg\_novision\_rl\_agent}
...
-explizites listing von der make\_noisy mit allen params
...
\begin{figure}[h]
	\centering 
	\includegraphics[trim={5.5cm 1.8cm 4.5cm 2cm},clip,width=1.05\textwidth]{reward_components}
...
\subsubsection{ddpg\_rl\_agent, dqn\_rl\_agent and dqn\_sv\_agent}



\subsubsection{ddpg\_novison\_rl\_agent and dqn\_novision\_rl\_agent}
