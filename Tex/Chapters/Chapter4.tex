...
\newcommand{\term}[1] {{\spaceskip=.75\fontdimen2\font minus \fontdimen4\font
...
-UML-diagramm des spiels
-ablaufdiagramm vom server-zeug dass zu dem von python passt
-welche tasten was machen (fake-speed undso)
