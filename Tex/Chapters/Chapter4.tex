...
\begin{figure}[h]
	...
	\caption[UML-diagram of an agent and its super-classes]{incomplete UML-diagram of an agent and its super-classes. A more complete version can be seen in \colorbox{red}{appendix~\cite{BLABLABLA}}
	\label{fig:agentMINI}
\end{figure}
